...
public class UpdateHelper {
    ...
    public static HashMap<String, String> updateTable(List<Table> tables, List<ChangeTable> changeTables) throws IOException {
        ...
        for (ChangeTable changeTable : changeTables) {
            ...
            File file = new File(path + SQLConstant.separatePath() + changeTable.getTableName() + ".txt");
            if (!file.exists()) {
            ...
            updateValueList.put(path + SQLConstant.separatePath() + changeTable.getTableName() + ".txt", valueList);
        }
    ...
    public static boolean isIntType(String word) {
        return word.matches("^int(.*)");
    }

    public static boolean isDoubleType(String word) {
        return word.matches("^double(.*)");
    }
    ...
    public static boolean isIntValue(String word) {
