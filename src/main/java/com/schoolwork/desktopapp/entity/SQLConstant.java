...
public class SQLConstant {
    // PC数据库的根路径
    private static final String pcRootPath = "C:\\mini_mysql";
    private static final String macRootPath = System.getProperty("user.home") + "/mini_mysql";
    // Mac数据库的根路径
    private static final String path = isMacOs() ? macRootPath : pcRootPath;
    private static final String sumpath = path + separatePath() + "Sum.txt";
    //数据库的当前路径
    private static final String grantpath = path + separatePath() + "Grant.txt";
    ...
    public static void setNowPath(String name) {
        nowPath = path + separatePath() + name;
